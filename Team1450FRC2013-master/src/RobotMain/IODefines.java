...
public class IODefines {
     //Relays
    public static final int COMPRESSOR_POWER = 1;
   ...
   // public static final int SHOOTER_SPEED_ENCODER = 12;
    ...
    public static final int FRONT_GRAPPLE_SERVO = 10;
    public static final int RIGHT_SECONDARY_DRIVE = 8;
    public static final int LEFT_SECONDARY_DRIVE = 9;
    //Analog Insc
